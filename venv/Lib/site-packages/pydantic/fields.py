...
class ModelPrivateAttr(_repr.Representation):
    """A descriptor for private attributes in class schemas.
...
def computed_field(
    ...
    *,
    ...
    Decorator to include `property` and `cached_property` when serializing schemas or dataclasses.
