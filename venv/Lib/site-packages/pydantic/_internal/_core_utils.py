...
def get_type_ref(type_: type[Any], args_override: tuple[type[Any], ...] | None = None) -> str:
    ...
    when creating generic schemas without needing to create a concrete class.
    """
...
def define_expected_missing_refs(
    ...
    if not allowed_missing_refs:
        ...
        # this is a common case (will be hit for all non-generic schemas), so it's worth optimizing for
        return None
