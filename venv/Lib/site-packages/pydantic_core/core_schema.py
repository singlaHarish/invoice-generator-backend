...
class CoreConfig(TypedDict, total=False):
    ...
    Attributes:
        ...
        from_attributes: Whether to use attributes for schemas, dataclasses, and tagged union keys.
        ...
        revalidate_instances: Whether instances of schemas and dataclasses should re-validate. Default is 'never'.
    ...
    # used for schemas, dataclasses, and tagged union keys
...
def model_schema(
    ...
    *,
    ...
    Args:
        ...
        revalidate_instances: whether instances of schemas and dataclasses (including subclass instances)
...
def definition_reference_schema(
    ...
    schemas and also when you want to define validators separately from the main schema, e.g.:
